...
$certificate_path = "/Certificats.p12";     // Change this to the path where your certificate is located
$certificate_password = "1748Tornynt"; // Change this to the certificate's import password
